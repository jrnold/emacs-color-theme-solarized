        ...
        (let ((bg-back   `(:background ,back))
          ...
          `((;; basic
             ...
             (mode-line  ; StatusLine
              ((t (,@fg-base00 ,@bg-base3 :box nil))))
             (mode-line-inactive ; StatusLineNC
              ((t (,@fg-base00 ,@bg-base2 :box nil))))
             (mode-line-buffer-id ; StatusLineNC
              ((t (,@fg-base00 ,@fmt-bold))))
             (mode-line-highlight ; StatusLineNC
              ((t (,@fg-orange ,@fmt-revbb))))
	     ...
	     (git-gutter:deleted ((t (,@fg-red))))
             ...
             ;;font-latex
             (font-latex-bold-face ((t (:inherit default ,@fmt-bold))))
	     (font-latex-doctex-documentation-face ((t (,@fg-base01 ,@fmt-ital))))
	     (font-latex-doctex-preprocessor-face
	      ((t (:inherit font-lock-preprocessor-face))))
             (font-latex-italic-face ((t (:inherit default ,@fmt-ital))))
             (font-latex-math-face ((t (,@fg-base1))))
             (font-latex-warning-face ((t (,@fg-red))))
	     (font-latex-sectioning-0-face ((t (,@fg-violet))))	     
	     (font-latex-sectioning-1-face ((t (,@fg-violet))))
             (font-latex-sectioning-2-face ((t (,@fg-violet))))
	     (font-latex-sectioning-3-face ((t (,@fg-violet))))
             (font-latex-sectioning-4-face ((t (,@fg-violet))))
             ...
             (font-latex-verbatim-face ((t (,@fmt-none ,@fg-green))))
             ;;flyspell
