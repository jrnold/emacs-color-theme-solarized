  ...
  (flet ((find-color (name)
    ...
    (let ((base03    (find-color 'base03))
      ...
      (let ((back base03))
	   ...
	   (font-latex-doctex-documentation-face ((t (:inherit font-lock-preprocessor-face))))
	   (font-latex-doctex-preprocessor-face ((t (:inherit font-lock-doc-string-face))))
	   (font-latex-italic-face ((t (:slant ,italic))))
	   (font-latex-math-face ((t (:foreground ,yellow))))
	   (font-latex-sectioning-0-face ((nil (:inherit header-line :weight ,bold))))
	   ...
	   (font-latex-subscript-face ((nil (:inherit default))))
	   (font-latex-superscript-face ((nil (:inherit default))))
	   (font-latex-verbatim-face ((nil (:inherit font-lock-doc-string-face))))
	   (font-latex-warning-face ((nil (:inherit font-lock-warning-face))))
	   )
